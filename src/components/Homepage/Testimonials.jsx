      ...
      <section>
        <div className="container py-4 py-sm-5">
          ...
          <div className="d-flex justify-content-end mt-4">
            <button className=" ff_nunito fw-semibold fs_xsm px-4 py-1 rounded-4 text-black bg_blue border_tran">
              View more
            </button>
          </div>
            ...
            <div className="col-sm-6 col-md-4 h-100 mt-4 mt-md-0">
              <div className="p-3 bg-white rounded-4 card_1">
                ...
                <p className="m-0 ff_space fw_400 opacity-75 fs_xsm pe-lg-3 mt-2">
                 A big shout to PG seekers for making the PG hunt so easy and comfortable.i recommend PG seekers to everyone who is looking to find PGs. 
                </p>
              </div>
            </div>
            <div className="col-sm-6 col-md-4 h-100 mt-4 mt-md-0">
              <div className="p-3 bg-white rounded-4 card_1">
                ...
                <p className="m-0 ff_space fw_400 opacity-75 fs_xsm pe-lg-3 mt-2">
                 Thanks to the PG ssekers who gave me so many opions to choose from, clearly he best website to find PGs for your settlement.
                </p>
              </div>
            </div>
            <div className="col-sm-6 col-md-4 h-100 mt-4 mt-md-0">
              <div className="p-3 bg-white rounded-4 card_1">
                ...
                <p className="m-0 ff_nunito fw-semibold fs_xsm">South Africa</p>
                <p className="m-0 ff_space fw_400 opacity-75 fs_xsm pe-lg-3 mt-2">
                  Thanku PG seekers, i was able to find very spacious and well maintained services apartment at a affordable price.
                </p>
              </div>
            </div>
          </div>
